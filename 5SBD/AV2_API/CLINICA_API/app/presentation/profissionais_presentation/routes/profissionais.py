...
from app.application.profissionais_application.atualizar_profissional import (
...
from app.application.profissionais_application.cadastrar_profissional import (
    CadastrarProfissional,
)
from app.application.profissionais_application.excluir_profissional import (
    ExcluirProfissional,
)
from app.application.profissionais_application.listar_profissionais import (
    ListarProfissionais,
)
from app.infrastructure.profissionais_infrastructure.repositories.profissional_repository_sqlalchemy import (
    ProfissionalRepositorySQLAlchemy,
)
from app.presentation.profissionais_presentation.schemas.profissional_schema import (
